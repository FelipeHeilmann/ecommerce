...
public class CustomerTest
{
    ...
    {
        await new CreateAccountCommandHandler(_customerRepository, _unitOfWork, _passwordHasher).Handle(new CreateAccountCommand(new CreateAccountModel("Felipe Heilmann", "felipeheilmannm@gmail.com", "senha", new DateTime(2004, 6, 2))), CancellationToken.None);
